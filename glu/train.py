...
train_word_path = '../swem/preproc/train_words.pkl'
valid_word_path = '../swem/preproc/valid_words.pkl'
train_cate_path = '../swem/preproc/train_cate.pkl'
valid_cate_path = '../swem/preproc/valid_cate.pkl'
...
if __name__ == '__main__':
    ...
    if args.model == 1:
        ...
        if args.resume:
            ...
            word2vec = torch.load('../swem/preproc/word2vec.pth')
        ...
        if args.resume:
            state = torch.load(ckpt)
            with open('../swem/preproc/mask.pkl', 'rb') as fp:
    ...
    if args.class_weight:
        with open('../swem/utils/class_weight.pkl', 'rb') as fp:
